...
## M6.2.4 capped specialization build
...
- Enforce global limits of three Specializations and three Masteries per player
  in the server skill-learn handler, without consuming skill points on denial.
